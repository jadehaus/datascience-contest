...
if __name__ == '__main__':
    ...
    train_dataset, valid_dataset = preprocess(train_file, norm_dict, value_feats string_feats, remove_feats, ratio=ratio)
    ...
    test_dataset = exam_loader(train_file, test_file, norm_dict, string_feats, remove_feats)
